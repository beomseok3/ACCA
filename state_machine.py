...
#kcity mission
 ...
 #kcity global driving test
    ...
    A2A3 = "pickup_A" #pickup

    A3A4 = "driving_B" #driving
    A4A5 = "obstacle_B" #small avoidance
    ...
    A12A13 = "driving_J" #big avoidance

    A13A14 = "driving_K" #driving
    A14A15 = "driving_L" #traffic

    A15A16 = "delivery_M" #delivery
    ...
    A30A31 = "driving_a" #driving
    A31A32 = "driving_b" #parking
...
class StateMachine():
    ...
    def update_cmd_msg(self):
        ...
        if self.state.value[:-2] == "driving":
            ...
            msg, self.mission_finish = self.parking.control_parking()
